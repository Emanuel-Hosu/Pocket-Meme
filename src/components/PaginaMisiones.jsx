                ...
                <div className="mx-auto px-4 py-6 max-w-2xl">
                    ...
                    <div className="space-y-6">
                        ...
                        {missions.map((mission) => (
                            <div
                                key={mission.id}
                                className="bg-stone-50 shadow-blue-400 shadow-md hover:shadow-2xl rounded-2xl transition-shadow duration-200 overflow-hidden"
                            >
                                <div className="flex justify-between p-2">
                                    ...
                                    <div className="flex-shrink-0 ml-2">
                                        <svg className='w-36 h-36 fill-blue-100' xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
