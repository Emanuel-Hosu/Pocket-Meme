...
const Prueba = () => {
    ...
    return (
        <div className="relative min-h-screen">
            <div className="flex justify-around items-center bg-stone-100 h-16">
                <button className="hover:shadow-inner rounded-full w-8 h-8 transition ease-in-out">
                    <svg xmlns="http://www.w3.org/2000/svg" className="drop-shadow-md w-8 h-8 text-[#cdcbca]" viewBox="0 -960 960 960" fill="currentColor">
                        <path
                ...
                <button onClick={handleButtonClick} className="hover:shadow-inner rounded-full w-8 h-8 transition ease-in-out">
                    <svg xmlns="http://www.w3.org/2000/svg" className="bg-blue-300 drop-shadow-lg rounded-xl w-8 h-8 text-white" viewBox="0 -960 960 960" fill="currentColor">
