...
const Footer = () => {
    return (
        <div className="flex justify-around items-center bg-gray-300 h-16">
            <button className="rounded-full w-10 h-10">
                <svg xmlns="http://www.w3.org/2000/svg" className="drop-shadow-md w-8 h-8 text-[#e1dce6]" viewBox="0 -960 960 960" fill="currentColor">
                    <path
            ...
            < button className="rounded-full w-10 h-10">
                <svg xmlns="http://www.w3.org/2000/svg" className="drop-shadow-md w-8 h-8 text-[#b3b3b3]" viewBox="0 -960 960 960" fill="currentColor">
                    <path
            ...
            <button className="rounded-full w-10 h-10">
                <svg xmlns="http://www.w3.org/2000/svg" className="bg-red-200 drop-shadow-lg rounded-xl w-8 h-8 text-[#e1dce6]" viewBox="0 -960 960 960" fill="currentColor">
