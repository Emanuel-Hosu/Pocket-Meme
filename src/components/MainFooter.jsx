                ...
                <div className="flex justify-around items-center h-16">
                    <a href="/main">
                        <button className="hover:shadow-stone-400 hover:shadow-inner rounded-full transition ease-in-out size-11">
                            <svg xmlns="http://www.w3.org/2000/svg" className="drop-shadow-md fill-stone-400" viewBox="0 -960 960 960" >
                                <path
                    ...
                    <a onClick={handleButtonClick}>
                        <button className="hover:shadow-inner hover:shadow-stone-400 rounded-full transition ease-in-out size-11">
                            <svg xmlns="http://www.w3.org/2000/svg" className="drop-shadow-lg fill-stone-400" viewBox="0 -960 960 960" >
