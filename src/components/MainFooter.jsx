...
const MainFooter = () => {
  ...
  const getButtonStyles = (path) => {
    ...
    return `hover:shadow-inner hover:shadow-blue-400 rounded-full transition ease-in-out size-11
            ${isActive ? 'shadow-lg shadow-blue-100 bg-blue-200' : ''}`;
  };

  const getIconStyles = (path) => {
    const isActive = location.pathname === path;
    return `drop-shadow-md ${isActive ? 'fill-blue-600' : 'fill-blue-400'}`;
  };
  ...
  return (
    <>
      ...
      <div className="relative z-10 flex justify-around items-center bg-white h-16">
        ...
        <a href="/colection">
          <button className={getButtonStyles('/colection')}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className={getIconStyles('/colection')}
              viewBox="0 -960 960 960"
            >
        ...
        <a href="/maitenance">
          <button className={getButtonStyles('/maitenance')}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className={getIconStyles('/maitenance')}
              viewBox="0 -960 960 960"
            >
        ...
        <a onClick={handleButtonClick}>
          <button className="hover:shadow-inner hover:shadow-blue-400 rounded-full transition ease-in-out size-11">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="drop-shadow-lg fill-blue-400"
              viewBox="0 -960 960 960"
            >
