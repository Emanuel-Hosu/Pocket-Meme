...
const MainFooter = () => {
    return (
        <div className="flex justify-around items-center bg-stone-300 h-16">
            <a href="#">
                <button className="hover:shadow-stone-400 hover:shadow-inner rounded-full transition ease-in-out size-11">
                    <svg xmlns="http://www.w3.org/2000/svg" className="drop-shadow-md fill-white" viewBox="0 -960 960 960" >
                        <path
            ...
            <a href="#">
                <button className="hover:shadow-inner hover:shadow-stone-400 rounded-full transition ease-in-out size-11">
                    <svg xmlns="http://www.w3.org/2000/svg" className="bg-blue-300 drop-shadow-lg rounded-xl fill-white" viewBox="0 -960 960 960" >
